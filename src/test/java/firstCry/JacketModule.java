...
//		a.accept()
	...
	@Test(priority=4)
	void jacketSection(){
		WebElement js=driver.findElement(By.xpath("//div[@class='header']//div[5]"));
		a.moveToElement(js).perform();
	}
	
	@Test(priority=5)
		void babyGirlJacket(){
			WebElement Bgj=driver.findElement(By.xpath("//li[normalize-space()='Baby Girl Jacket']"));
			a.moveToElement(Bgj).click();
            }
}
