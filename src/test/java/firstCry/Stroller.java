...
//    	a.accept();
	...
	@Test(priority=4)
	void strollerSection(){
		WebElement js=driver.findElement(By.xpath("//div[@class='header']//div[6]"));
		a.moveToElement(js).perform();
	}
	
	@Test(priority=5)
		void babyHugStroller(){
			WebElement Bhs=driver.findElement(By.xpath("//li[normalize-space()='Babyhug Stroller']"));
			//a.moveToElement(Bhs).click();
			Bhs.click();
            }
	
	@Test(priority=6)
	void addTocart(){
		WebElement img1=driver.findElement(By.xpath("//body/div[@id='root']/div/div[@class='product']/div/div[@class='Active Product-list-card-container']/div[1]/div[1]/div[1]"));
		//a.moveToElement(Bhs).click();
		img1.click();
        }
