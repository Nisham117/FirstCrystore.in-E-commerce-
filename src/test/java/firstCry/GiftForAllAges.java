...
//    	a.accept();
	...
	@Test(priority=4)
	void giftforAllAgeSection(){
		WebElement Gfaa=driver.findElement(By.xpath("//a[normalize-space()='Gifts For All Ages']"));
		//a.moveToElement(Gfaa).perform();
		Gfaa.click();
	}
