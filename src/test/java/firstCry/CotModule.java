...
//		a.accept();
	...
	@Test(priority=4)
	void cotSection(){
		WebElement cs=driver.findElement(By.xpath("//div[@class='header']//div[4]"));
		a.moveToElement(cs).perform();
	}
	
	@Test(priority=5)
		void woodenBabyCot(){
			WebElement Wbc=driver.findElement(By.xpath("//li[normalize-space()='Wooden Baby Cot']"));
			a.moveToElement(Wbc).click();
            }
